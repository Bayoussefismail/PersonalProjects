...
<body>
  ...
  <div id="text1"class="leftdiv">
    ...
    <p class="p1 slideup">on classic design, interios and landscapes from our</p>
    <p class="p1 slideup">inception in 2020, we have delivered elegant private and</p>
    <p class="p1 slideup">buisiness environements that are stimulating to occupy and</p>
    <p class="p1 slideup">fundamental to their surroundings.</p>
    <br>
    <p class="p1 slideup">As a full service firm, CLASSARCH is present on projects from</p>
    <p class="p1 slideup">start to finish, ensuring that the ideas conceived in the</p>
    <p class="p1 slideup">beginning with clients are manifest at the end. We achieve</p>
      ...
      <div class="slider">
        ...
        <div class="slide slide1">
          <div class="slide-content1">
            <div class="namesteven">
              <h6 class="sub1 slideup2 element">DESIGNER</h6>
              <p class="namefirst slideup2 element">STEVEN MCDOLLAR</p>
            </div>
            <div class="">
              <img class="specialbarb imganime4" src="background.PNG" alt="">
              <img class="barabara" src="barbara.jpg" alt="">
            </div>
            <div class="namebarbara">
              <h6 class="sub1 slideup2 element">ARCHITECT</h6>
              <p class="namefirst slideup2 element">BARBARA KNOWLES</p>
            </div>
            <div class="steven">
              <img class="specialsteven imganime5" src="background.PNG" alt="">
              <img src="steven.jpg" alt="">
            </div>
          </div>
        </div>
        <!-- Slideshow 2-->
        <div class="slide slide2">
          <div class="slide-content1">
            <div class="namesteven">
              <h6 class="sub2 slideup2">CO-FOUNDER & DESIGNER</h6>
              <p class="namefirst slideup2">EDGAR WILSON</p>
            </div>
            <div class="">
              <img class="specialbarb imganime4" src="background.PNG" alt="">
              <img class="barabara2" src="BROWN.jpg" alt="">
            </div>
            <div class="namebarbara">
              <h6 class="sub2 slideup2">CO-FOUNDER & ARCHITECT</h6>
              <p class="namefirst slideup2">MARY BROWNS</p>
            </div>
            <div class="steven">
              <img class="specialsteven imganime5" src="background.PNG" alt="">
              <img class="edgar" src="EDGAR.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
  ...
  <div id="slider2"class="">
       ...
       <div class="wrap2">
         ...
         <div class="slider">
           <!-- Slideshow 1 -->
           <div class="slide3 slide1">
             <div class="slide-content2">
               <div class="namesteven2">
                 <h1 class="classarch slideup" id="2">BLOOM'S</h1>
                 <h1 class="classarch slideup">HOUSE</h1>
                 <p class="p1 slideup">Bloom's House renovation allowed the architect, interior</p>
                 <p class="p1 slideup">designer and client to come together through an inctusive</p>
                 <p class="p1 slideup">process. The result was the creation of a cistilled traditional</p>
                 <p class="p1 slideup">space that successfully balances the nature and</p>
                 <p class="p1 slideup">industrial, marries traditional European vintage style to</p>
                 <p class="p1 slideup">a western North American vibe.</p>
               </div>
               <div class="deco">
                 <img class="specialdeco1 imganime4" src="background.PNG" alt="">
                 <img class="deco1" src="pic1.jpg" alt="">
               </div>
               <div class="steven2">
                 <img class="specialdeco2 imganime5" src="background.PNG" alt="">
                 <img class="deco2" src="pic 3.jpg" alt="">
               </div>
               <div class="">
                 <img class="specialdeco3 imganime5" src="background.PNG" alt="">
                 <img class="deco3" src="pic2.jpg" alt="">
               </div>
         ...
         <hr id="righthr2" class="hrrightanim righthr2">
       </div>
      </div>
...
<div class="leftdiv2">
  ...
  <div class="contactelements1">
    <h6 class="sub1 slideup element">PHONE.</h6>
    <p class="namefirst slideup element">213-353-9016</p>
  </div>
<div class="contactelements2">

  <h6 class="sub1 slideup element">ADRESS.</h6>
